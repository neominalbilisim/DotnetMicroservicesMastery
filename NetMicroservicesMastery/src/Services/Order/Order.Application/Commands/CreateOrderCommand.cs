...
public class CreateOrderCommandHandler(
    ...
    IOrderDynamicConfiguration dynamicConfiguration) : IRequestHandler<CreateOrderCommand, CreateOrderResult>
{
    public async Task<CreateOrderResult> Handle(CreateOrderCommand request, CancellationToken cancellationToken)
    {
        ...
        await eventPublisher.PublishOrderCreatedAsync(orderId, request.CustomerId, request.TotalAmount, cancellationToken);
